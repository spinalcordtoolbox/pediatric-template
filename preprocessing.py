...
path_data = '/home/user/Desktop/NewTDs/'
...
list_centerline = generate_centerline(dataset_info=dataset_info, contrast='t2')
...
straighten_all_subjects(dataset_info=dataset_info, contrast='t2')
...
copy_preprocessed_images(dataset_info=dataset_info, contrast='t2')

# converting results to Minc format
convert_data2mnc(dataset_info, contrast='t2')
